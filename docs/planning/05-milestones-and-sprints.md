...
- Report-pipeline model selection is the same on every plan (Bedrock Nova Micro + DeepSeek + Nova 2 Lite)
...
| 2 | AI Orchestration | 7-stage durable pipeline (Nova Micro + DeepSeek + Nova 2 Lite) |
