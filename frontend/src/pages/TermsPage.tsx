    ...
    <div className="legal-shell">
      ...
      <main id="main" tabIndex={-1} className="legal-main">
        <article className="legal-article">
          ...
          <p>
            We recommend that you print a copy of these Legal Terms for your records. Our{' '}
          ...
          <p>
            The information provided on or through the Services is not intended for distribution to or use by any person
          ...
          <p>
            Subject to your compliance with these Legal Terms, including the prohibited activities set forth herein, we
            grant you a non-exclusive, non-transferable, revocable license to access the Services solely for your
            personal, non-commercial use.
          </p>
          <h3>Your submissions</h3>
          <p>
            You acknowledge and agree that any questions, comments, suggestions, ideas, feedback, or other information
            regarding the Services (&quot;Submissions&quot;) provided by you to us are non-confidential and shall
          ...
          <ul>
            <li>systematically retrieve data or other content from the Services to create or compile a collection without our written permission;</li>
            ...
            <li>defraud, mislead, or attempt to defraud or mislead us or other users;</li>
            ...
            <li>use the Services as part of any effort to compete with us or otherwise use the Services for any revenue-generating endeavor without our prior written consent;</li>
            ...
            <li>delete the copyright or other proprietary rights notice from any Content; or</li>
            <li>use the Services in a manner inconsistent with any applicable laws or regulations.</li>
          </ul>

          <h2 id="ugc">5. User generated contributions</h2>
          <p>
            The Services may invite you to chat, contribute to blogs or message boards, participate in forums, and other
            functionality, and may provide you with the opportunity to create, submit, post, display, transmit, perform,
            publish, distribute, or broadcast content and materials to us or on the Services, including but not limited
          ...
          <ol>
            ...
            <li>
              your Contributions do not ridicule, mock, disparage, intimidate, or abuse anyone; your Contributions do
              not advocate the violent overthrow of any government or incite, encourage, or threaten physical harm against
              another;
            </li>
            <li>
              your Contributions do not contain instructions for the illegal design, or manufacture of any items;
            </li>
            <li>
              your Contributions do not contain any material that solicits personal information from anyone under the age
          ...
          <p>
            ...
            <a href="https://www.adr.org/" target="_blank" rel="noopener noreferrer">www.adr.org</a>). Your arbitration
          ...
          <p className="legal-allcaps">
            ...
            ANY NATURE WHATSOEVER, RESULTING FROM YOUR ACCESS TO AND USE OF THE SERVICES, (3) ANY UNAUTHORIZED ACCESS TO
            ...
            TROJAN HORSES, OR THE LIKE WHICH MAY BE TRANSMITTED TO OR THROUGH THE SERVICES BY ANY THIRD PARTY, AND/OR (6)
          ...
          <p>
            ...
            are required to indemnify us, and you agree to cooperate, at your expense, with our defense of such claims. We
          ...
          <p>
            ...
            these Legal Terms is determined to be unlawful, void, or unenforceable, that provision or part of the provision
            is deemed severable from these Legal Terms and does not affect the validity and enforceability of any
