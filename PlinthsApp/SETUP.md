...
## Status
Milestone 3 complete: signing in enters a dark Stealth-Desert **workspace** —
...
fixtures); the real API lands in M4.
...
Next milestones: wire real API + add a test target (M4), real auth (M5). See
