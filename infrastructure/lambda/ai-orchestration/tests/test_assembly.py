...
def _fixtures():
    ...
    search_results = {
        ...
        "pain_sources": [
            {"label": "Reddit", "url": "https://reddit.com/a"},
    ...
    summary = {
        ...
        "entry_cost": [
            {"label": "Rules & privacy", "value": "careful with health data"}
        ],
...
def test_assemble_v2_keeps_legacy_and_structured_keys():
    ...
    assert (
        out["entry_cost"][0]["tier"] == "fact"
    )  # regulatory/rules&privacy defaults to fact
